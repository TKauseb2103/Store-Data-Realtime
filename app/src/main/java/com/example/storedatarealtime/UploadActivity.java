...
//        });
    ...
    public void uploadData() {
        ...
        DataClass dataClass = new DataClass(topic, desc, lang, imageUrl);

        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(topic).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
